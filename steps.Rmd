...
* Make a folder for your feature in [the archive](https://drive.google.com/drive/u/2/folders/1Rrm0NOH2E7dGMC97TdCFhjg7Y_FrAU3i) and copy [the feature template](https://docs.google.com/spreadsheets/d/1HCoEBiz8A2Vd9LUApRLtMANpnsUJN-k6EaXrBYfN0IU/edit#gid=0) in it.

-----------

## Step 2 - Add data

* Download [the feature template](https://docs.google.com/spreadsheets/d/1HCoEBiz8A2Vd9LUApRLtMANpnsUJN-k6EaXrBYfN0IU/edit#gid=0).
 
* Collect data for each language from descriptive literature, which you can find in [our library](https://drive.google.com/drive/u/2/folders/14RBA31Cj1MsFSiV4E_ZqTLGOhI1dUfMD). Fill all required columns (see [Feature datasets > List of columns](datasets.html#list-of-columns) for an explanation of the column names).

* (Optional) If you want to use a source that is not in the library yet:

  + Submit information about the source via [this form](https://docs.google.com/forms/d/e/1FAIpQLSfekbCiSi5TVtJDAWcAzIajkwYyoR8WjRJ1tjkt0QS6kdkIEA/viewform?usp=sf_link). Each source should be assigned a **bibtexkey** -- a unique identifier that allows us to easily cite sources across the Atlas. See [Feature datasets > Literature references > Adding new literature](datasets.html#adding-new-literature) on how to construct a key. Be sure to check whether the key is already taken.
...
See [Datasests](datasest.html) for more detailed guidelines.
 
-----------

## Step 3 - Write a chapter

* Write an introductory chapter about your feature in `rmarkdown` using our [chapter template](chapter_template/chapter_template.Rmd). 
...
* **Make sure the filenames of your feature table, text, and references are the same**, e.g. `evidentialtytense.tsv` (data), `evidentialitytense.Rmd` (text), `evidentialitytense_bib.tsv` (chapter references) 
