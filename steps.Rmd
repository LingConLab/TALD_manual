...
Collect information for each language in [the feature template](https://docs.google.com/spreadsheets/d/1HCoEBiz8A2Vd9LUApRLtMANpnsUJN-k6EaXrBYfN0IU/edit#gid=0). Fill all required columns (see [Feature datasets > List of columns](datasets.html#list-of-columns) for an explanation of the column names).
...
Write an introductory chapter about your feature in `rmarkdown` using our [chapter template](chapter_template/chapter_template.Rmd). See [Writing a chapter](chapters.html) for more detailed guidelines.
