...
Don't be scared if you are not very experienced with R: all you need to format a chapter is [R](https://www.r-project.org) + [RStudio](https://www.rstudio.com) and our [chapter template](https://github.com/LingConLab/TALD_manual/blob/main/chapter_template/chapter_template.Rmd).
