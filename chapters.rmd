...
It can be convenient to write a draft in a google doc in your feature folder, but ultimately the text will have to be formatted in `Rmarkdown`. You can download a template for formatting a chapter [here](chapter_template/chapter_template.Rmd) and [the cheat sheet](chapter_template/chapter_cheatsheet.Rmd).
