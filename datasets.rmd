...
- **group** - language branch/group (optional)
- **language** - language name (see [the following page](https://lingconlab.github.io/TALD/languages.html) and [this dataset](https://raw.githubusercontent.com/LingConLab/TALD/refs/heads/master/data/tald_villages.csv) for the details)
- **idiom** - the name of a language variety; descriptive sources provide information on specific dialects or village varieties of languages, and we aim to be as precise as possible about where our information comes from; this also means that if a source says: "in dialect X, the same form is used", you can add this as an observation to your dataset. (see [the following page](https://lingconlab.github.io/TALD/languages.html) and [this dataset](https://raw.githubusercontent.com/LingConLab/TALD/refs/heads/master/data/tald_villages.csv) for the details)
