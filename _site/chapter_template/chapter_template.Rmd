...
Each table should have a reference in the text, for example look at [Table 1](#m1)! The header of each table should be styled as follows (`#m1` is the key of the table, it is used to refer to the table in the text, the number in the key changes for each table):
...
Note that, if you want to bold several words, then `**` should be around each of them: `transliteration = "**bur-e-ri** **c'in-ne-sːu**"`
