...
Although the language sample underlying [TALD](https://lingconlab.ru/tald) has grown to include a number of neighboring languages (more on that in [Language sample](#the-language-sample) below), the core of the project remains Daghestan.
