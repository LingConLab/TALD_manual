...
Each table should have a reference in the text, for example look at [Table 1](#m1)! The header of each table should be styled as follows (`#m1` is the key of the table, it is used to refer to the table in the text, the number in the key changes for each table). If you need to align the text in a column, use `:`
...
#### **Figure 1.** Map of some languages {#f2 -}
...
References are generated automatically if you provide a table with the references, as described [here](chapters.html#literature_references).
