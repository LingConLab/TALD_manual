...
<!-- - If applicable: describes how the classification in [TALD](https://lingconlab.ru/tald) differs from [WALS](http://wals.info) (e.g. our chapter on the [Standard of Comparison](http://lingconlab.ru/dagatlas/standard_of_comparison.html) shows more sub-types of spatial comparatives) -->
